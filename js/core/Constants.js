...
const DOWNLOAD_TYPES = {
  ...
  toString: () => 'DOWNLOAD_TYPES',
};
DOWNLOAD_TYPES.isValid = isValid(DOWNLOAD_TYPES);

const MESSAGE_TYPES = {
  SIGNAL : 'SIGNAL',
  DATA_PIECE : 'DATA_PIECE',
  DATA_PIECE_REQUEST: 'DATA_PIECE_REQUEST',
  META_DATA_PIECE: 'META_DATA_PIECE',
  META_DATA_PIECE_REQUEST: 'META_DATA_PIECE_REQUEST'
};
MESSAGE_TYPES.isValid = isValid(MESSAGE_TYPES); //Validates if given value is an instance of this ENUM
...
export {EVENT,EXCEPTION,DEFINE_ENUM_PROPERTY,DEFINE_CONST_PROPERTY,SIGNAL_TYPES,SIGNAL_STATUS,CONNECTION_STATUS,DOWNLOAD_STATUS,DATA_TYPES,MESSAGE_TYPES,DOWNLOAD_TYPES,CONFIG}
